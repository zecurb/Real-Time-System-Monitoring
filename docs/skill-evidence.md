...
| --- | --- | --- | --- |
| Python | Demonstrated | Typed collector, API, durable worker, configuration, and 14-test suite pass lint and strict typing | Independently extend a processor |
...
| Time-series analysis | Practiced | Normalized series, chronological range queries, stable cursors, retention, and historical backfill | Add window aggregation and baseline analysis |
